...
.glitch-text::after {
    left: -3px;
    text-shadow: 3px 0 #8b5cf6, -3px -3px #ec4899;
    clip: rect(0, 9999px, 200px, 0);
...
@keyframes glitch-anim2 {
    0% {
        clip: rect(80px, 9999px, 160px, 0);
        transform: skew(0deg);
        opacity: 0;
    }
    15% {
        clip: rect(100px, 9999px, 180px, 0);
        transform: skew(-0.3deg);
        opacity: 0.7;
    }
    30% {
...
.loading-phrase {
    ...
    min-height: 1.5em;
    opacity: 0;
    animation: phraseFadeIn 0.5s ease forwards;
}
...
/* Remove all stylized effects - make letters normal and readable */
.logo-d,
.logo-r,
.logo-a,
.logo-z,
...
.hero-keywords:hover .keyword-separator {
    opacity: 0.3;
}
...
.hero-join-btn:hover .join-btn-icon {
...
.hero-join-btn:hover .join-btn-glow {
    opacity: 1;
...
.visual-orb {
    ...
    filter: blur(60px);
    opacity: 0.4;
    animation: visualOrbFloat 8s infinite ease-in-out;
}
...
.logo-animation {
    margin-bottom: 2rem;
    opacity: 0;
    animation: logoReveal 1.2s ease-out 0.1s forwards;
    position: relative;
    z-index: 2;
}
...
.title-sentence:nth-child(1) {
    padding-left: 0;
}

.title-sentence:nth-child(2) {
    padding-left: 80px;
}

.title-sentence:nth-child(3) {
    padding-left: 160px;
}
...
.title-sentence .word {
    ...
    animation: wordSlideUp 0.6s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards;
    margin-right: 0.3em;
}

.title-sentence:nth-child(1) .word:nth-child(1) {
    animation-delay: 0.2s;
}

.title-sentence:nth-child(1) .word:nth-child(2) {
    animation-delay: 0.4s;
}

.title-sentence:nth-child(2) .word:nth-child(1) {
    animation-delay: 0.6s;
}

.title-sentence:nth-child(2) .word:nth-child(2) {
    animation-delay: 0.8s;
}

.title-sentence:nth-child(3) .word {
    animation-delay: 1s;
}
...
.float-2 {
    top: 60%;
    right: 15%;
    animation: floatElement 18s infinite ease-in-out 2s;
}

.float-3 {
    bottom: 30%;
    left: 20%;
    animation: floatElement 20s infinite ease-in-out 4s;
}
...
.web-line {
    ...
    animation: drawWebLine 2s ease-out forwards;
    opacity: 0.6;
...
.web-node {
    opacity: 0;
    animation: nodePulse 1s ease-out 1s forwards, nodeGlow 2s ease-in-out 2s infinite;
    filter: drop-shadow(0 0 8px rgba(99, 102, 241, 0.8));
}

@keyframes drawWebLine {
    to {
        stroke-dashoffset: 0;
        opacity: 0.7;
    }
...
.feature-card:nth-child(1) .border-runner {
    animation-delay: 0s;
}

.feature-card:nth-child(2) .border-runner {
    animation-delay: 1.5s;
}

.feature-card:nth-child(3) .border-runner {
    animation-delay: 3s;
}

.feature-card:nth-child(4) .border-runner {
...
.large-card-icon .icon-svg.active {
    opacity: 1;
...
.igaming-card:hover .igaming-icon {
...
.igaming-card:hover .igaming-icon svg {
    transform: scale(1.1);
}
...
.launch-card:hover .launch-icon::after {
    opacity: 1;
    transform: scale(1.1);
...
.economy-point:hover .point-number {
    transform: scale(1.1) rotate(5deg);
    box-shadow: 0 10px 30px rgba(99, 102, 241, 0.5);
}
...
.economy-point:hover .point-number::after {
    opacity: 1;
    transform: scale(1.1);
}
...
@media (max-width: 480px) {
    ...
    .web-lines {
        display: none; /* Скрываем паутину на маленьких экранах */
    }
...
@media (max-width: 360px) {
    ...
    /* Уменьшаем орбы еще больше на очень маленьких экранах */
    .orb-1 {
        width: 200px;
        height: 200px;
        top: -50px;
